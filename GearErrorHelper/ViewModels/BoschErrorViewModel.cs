...
public partial class BoschErrorViewModel : BaseViewModel
{
	[ObservableProperty]
	...
	//Lists
	[ObservableProperty]
	private ObservableCollection<BoschErrorModel> errorTypes;

	//Selected
	private BoschErrorModel selectedErrorType;
	public BoschErrorModel SelectedErrorType
	{
		get { return selectedErrorType; }
		set { selectedErrorType = value; }
	}

	public BoschErrorViewModel()
	{
		ErrorTypes = new ObservableCollection<BoschErrorModel>();

		//Add the error types to the list
		ErrorTypes.Add(new BoschErrorModel { Key = 1, Value = "E", Display = "Error" });
		ErrorTypes.Add(new BoschErrorModel { Key = 2, Value = "W", Display = "Warning" });
		ErrorTypes.Add(new BoschErrorModel { Key = 3, Value = "I", Display = "Information" });
